...
import com.twilio.moviesbot.services.verification.PhoneVerificationService;
...
public class PhoneVerificationController {
	...
	public ResponseEntity<String> sendVerificationToken(@PathVariable String phoneNumber, @PathVariable String channel){
